...
const selectMediaUrlsCreateTopicForm = new Choices('#select-mediaUrls-create-topic-form', {
    delimiter: ',',
    editItems: true,
...
const selectMediaUrlsCreateReportForm = new Choices('#select-mediaUrls-create-report-form', {
    delimiter: ',',
    editItems: true,
    addItemFilter: function(value) {
        if (!value) {
